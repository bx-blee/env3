;;; completion-init.el --- FILE DESCRIPTION COMES HERE  -*- lexical-binding: t; -*-

(orgCmntBegin "
* Summary:
" orgCmntEnd)

;;;#+BEGIN: b:elisp:file/copyLeftCompletions :outLevel 1
(orgCmntBegin "
...
;;;#+BEGIN:  b:elisp:defs/defun :defName "b:base:completion|init"
(orgCmntBegin "
* [[elisp:(show-all)][(>]]  =defun= <<b:base:completion|init>> [[elisp:(org-shifttab)][<)]] E|
" orgCmntEnd)
(defun b:base:completion|init (
;;;#+END:
                        )
   " #+begin_org
...
(b:base:completions|init)
#+END_SRC

#+RESULTS:
| bnpa:comeega:config | main | /bisos/git/auth/bxRepos/blee/env3/completions/completion-init.el | 72 |
