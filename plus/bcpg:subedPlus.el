;;; bcpg:subedPlus.el --- Blee Component Pkg Grouping (subedPlus)  -*- lexical-binding: t; -*-

;;;#+BEGIN: b:elisp:pkg/summaryText :outLevel 1 :pkgAdoptionType "bcpg" :pkgName "subedPlus"
(orgCmntBegin "
* [[elisp:(show-all)][(>]] Summary:  bcpg Adoption of :subedPlus
...
;;;#+BEGIN: b:elisp:pkg/usgEnabled?defvar :outLevel 2 :pkgAdoptionType "bcpg" :pkgName "subedPlus"
(orgCmntBegin "
** [[elisp:(show-all)][(>]]  =defvar= <<bcpg:subedPlus:usgEnabled?>> [[elisp:(org-shifttab)][<)]] E|
" orgCmntEnd)
(defvar bcpg:subedPlus:usgEnabled? t "subedPlus package adoption control.")
;;;#+END:
...
;;;#+BEGIN: b:elisp:pkg/fullUpdate :outLevel 1 :pkgsStage "ready" :pkgAdoptionType "bcpg" :pkgName "subedPlus"
(orgCmntBegin "
*  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_ _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_ [[elisp:(outline-show-branches+toggle)][|=]] [[elisp:(bx:orgm:indirectBufOther)][|>]] *[[elisp:(blee:ppmm:org-mode-toggle)][|N]]*  defun      [[elisp:(outline-show-subtree+toggle)][||]]  <<bcpg:subedPlus|fullUpdate>>  --  --   [[elisp:(org-cycle)][| ]]
" orgCmntEnd)
(defun bcpg:subedPlus|fullUpdate ()
   " #+begin_org
** DocStr: *subedPlus* package adoption full update template.
#+end_org "
 (b:log|entry (b:func$entry)) (when bcpg:subedPlus:usgEnabled?
    (bcpg:subedPlus:install|update)
    (bcpg:subedPlus:config|main)
    )
  )
;;;#+END:
...
;;;#+END:
   ...
   (orgCmntBegin "
** [[elisp:(show-all)][(>]]  =component= ~subed~~ *pkgDesc* [[elisp:(org-shifttab)][<)]] E|
...
" orgCmntEnd)
(defun bcpg:subedPlus:config|main ()
   " #+begin_org
