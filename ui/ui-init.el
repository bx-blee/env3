;;; ui-init.el --- FILE DESCRIPTION COMES HERE  -*- lexical-binding: t; -*-

(orgCmntBegin "
* Summary:
" orgCmntEnd)

;;;#+BEGIN: b:elisp:file/copyLeftUi :outLevel 1
(orgCmntBegin "
...
;;;#+BEGIN:  b:elisp:defs/defun :defName "b:base:ui|init"
(orgCmntBegin "
* [[elisp:(show-all)][(>]]  =defun= <<b:base:ui|init>> [[elisp:(org-shifttab)][<)]] E|
" orgCmntEnd)
(defun b:base:ui|init (
;;;#+END:
                        )
   " #+begin_org
...
#+RESULTS:
| bnpa:comeega:config | main | /bisos/git/auth/bxRepos/blee/env3/ui/ui-init.el | 72 |
