;;; realms-user-init.el --- FILE DESCRIPTION COMES HERE  -*- lexical-binding: t; -*-

(orgCmntBegin "
* Summary:
" orgCmntEnd)

;;;#+BEGIN: b:elisp:file/copyLeftRealms-Users :outLevel 1
(orgCmntBegin "
...
;;;#+BEGIN:  b:elisp:defs/defun :defName "b:base:realms-user|init"
(orgCmntBegin "
* [[elisp:(show-all)][(>]]  =defun= <<b:base:realms-user|init>> [[elisp:(org-shifttab)][<)]] E|
" orgCmntEnd)
(defun b:base:realms-user|init (
;;;#+END:
                        )
   " #+begin_org
...
#+end_org "
  ...
  ;;(require 'boot-realmPre)
  ;;(bap:gif-screencast:full/update)

  (require 'boot-realmPost)
  (b:realm:user:boot|post)
...
(b:base:realms-users|init)
#+END_SRC

#+RESULTS:
| bnpa:comeega:config | main | /bisos/git/auth/bxRepos/blee/env3/realms-users/realms-user-init.el | 72 |

" orgCmntEnd)

;;;#+BEGIN: b:elisp:file/provide :modName nil
(provide 'realms-user-init)
;;;#+END:
