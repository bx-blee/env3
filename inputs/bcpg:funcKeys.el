;;; bcpg:funcKeys.el --- Blee Component Pkg Grouping (funcKeys)  -*- lexical-binding: t; -*-

;;;#+BEGIN: b:elisp:pkg/summaryText :outLevel 1 :pkgAdoptionType "bcpg" :pkgName "funcKeys"
(orgCmntBegin "
* [[elisp:(show-all)][(>]] Summary:  bcpg Adoption of :funcKeys
...
;;;#+BEGIN: b:elisp:pkg/usgEnabled?defvar :outLevel 2 :pkgAdoptionType "bcpg" :pkgName "funcKeys"
(orgCmntBegin "
** [[elisp:(show-all)][(>]]  =defvar= <<bcpg:funcKeys:usgEnabled?>> [[elisp:(org-shifttab)][<)]] E|
" orgCmntEnd)
(defvar bcpg:funcKeys:usgEnabled? t "funcKeys package adoption control.")
;;;#+END:
...
;;;#+BEGIN: b:elisp:pkg/fullUpdate :outLevel 1 :pkgsStage "ready" :pkgAdoptionType "bcpg" :pkgName "funcKeys"
(orgCmntBegin "
* [[elisp:(show-all)][(>]]  =defun= <<bcpg:funcKeys|fullUpdate>> [[elisp:(org-shifttab)][<)]] E|
" orgCmntEnd)
(defun bcpg:funcKeys|fullUpdate ()
 "funcKeys package adoption control."
 (b:log|entry (b:func$entry))
  (when bcpg:funcKeys:usgEnabled?
    (bcpg:funcKeys:install|update)
    (bcpg:funcKeys:config|main)
    )
  )
;;;#+END:

;;;#+BEGIN: b:elisp:pkg:install/update :outLevel 1 :pkgsStage "ready" :pkgAdoptionType "bcpg" :pkgName "funcKeys"
(orgCmntBegin "
* [[elisp:(show-all)][(>]]  =defun= <<bcpg:funcKeys:install|update>> [[elisp:(org-shifttab)][<)]] E|
" orgCmntEnd)
(defun bcpg:funcKeys:install|update ()
 "funcKeys package adoption install or update template."
 (b:log|entry (b:func$entry))
;;;#+END:
   ;;; Installation Material Comes Here
   )

;;;#+BEGIN: b:elisp:pkg:config/main :outLevel 1 :pkgsStage "ready" :pkgAdoptionType "bcpg" :pkgName "funcKeys"
(orgCmntBegin "
* [[elisp:(show-all)][(>]]  =defun= <<bcpg:funcKeys:install|update>> [[elisp:(org-shifttab)][<)]] E|
" orgCmntEnd)
(defun bcpg:funcKeys:config|main ()
 "funcKeys package adoption config template."
 (b:log|entry (b:func$entry))
;;;#+END:
