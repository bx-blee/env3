;;; inputs-init.el --- FILE DESCRIPTION COMES HERE  -*- lexical-binding: t; -*-

(orgCmntBegin "
* Summary:
" orgCmntEnd)

;;;#+BEGIN: b:elisp:file/copyLeftInputs :outLevel 1
(orgCmntBegin "
...
;;;#+BEGIN:  b:elisp:defs/defun :defName "b:base:inputs|init"
(orgCmntBegin "
* [[elisp:(show-all)][(>]]  =defun= <<b:base:inputs|init>> [[elisp:(org-shifttab)][<)]] E|
" orgCmntEnd)
(defun b:base:inputs|init (
;;;#+END:
                        )
   " #+begin_org
...
#+RESULTS:
| bnpa:comeega:config | main | /bisos/git/auth/bxRepos/blee/env3/inputs/inputs-init.el | 72 |
