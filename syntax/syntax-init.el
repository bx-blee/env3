;;; syntax-init.el --- FILE DESCRIPTION COMES HERE  -*- lexical-binding: t; -*-

(orgCmntBegin "
* Summary:
" orgCmntEnd)

;;;#+BEGIN: b:elisp:file/copyLeftSyntaxs :outLevel 1
(orgCmntBegin "
...
;;;#+BEGIN:  b:elisp:defs/defun :defName "b:base:syntax|init"
(orgCmntBegin "
* [[elisp:(show-all)][(>]]  =defun= <<b:base:syntax|init>> [[elisp:(org-shifttab)][<)]] E|
" orgCmntEnd)
(defun b:base:syntax|init (
;;;#+END:
                        )
   " #+begin_org
...
#+RESULTS:
| bnpa:comeega:config | main | /bisos/git/auth/bxRepos/blee/env3/syntaxs/syntax-init.el | 72 |
