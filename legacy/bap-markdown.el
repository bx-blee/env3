...
(setq bap:markdown:usage:enabled-p t)


;;
;; (bap:markdown:full/update)
;;
(defun bap:markdown:full/update ()
  ""
  (interactive)
  (blee:ann|this-func (compile-time-function-name))
  (when bap:markdown:usage:enabled-p
    (bap:markdown:install/update)
    (bap:markdown:config/main)
    )
  )

(defun bap:markdown:install/update ()
  ""
  (interactive)
  (blee:ann|this-func (compile-time-function-name))  

  (b:pkg:straight|install 'markdown-mode)
...
(defun bap:markdown:config/main ()
  ""
  (interactive)
  (blee:ann|this-func (compile-time-function-name))    
