;;; auto-complete-init.el --- FILE DESCRIPTION COMES HERE  -*- lexical-binding: t; -*-

(orgCmntBegin "
* Summary:
" orgCmntEnd)

;;;#+BEGIN: b:elisp:file/copyLeftAuto-Complete :outLevel 1
(orgCmntBegin "
...
;;;#+BEGIN:  b:elisp:defs/defun :defName "b:base:auto-complete|init"
(orgCmntBegin "
* [[elisp:(show-all)][(>]]  =defun= <<b:base:auto-complete|init>> [[elisp:(org-shifttab)][<)]] E|
" orgCmntEnd)
(defun b:base:auto-complete|init (
;;;#+END:
                        )
   " #+begin_org
...
#+end_org "
   ...
   (require 'bcpg:companyPlus)
   (bcpg:companyPlus|fullUpdate)
...
#+RESULTS:
| bnpa:comeega:config | main | /bisos/git/auth/bxRepos/blee/env3/auto-complete/auto-complete-init.el | 72 |
