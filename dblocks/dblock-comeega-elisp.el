...
;;;#+BEGIN:  b:elisp:defs/defun :defName "org-dblock-write:b:elisp:defs/dblockDefun" :advice ("bx:dblock:control|wrapper")
(orgCmntBegin "
*  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_ _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_ [[elisp:(outline-show-branches+toggle)][|=]] [[elisp:(bx:orgm:indirectBufOther)][|>]] *[[elisp:(blee:ppmm:org-mode-toggle)][|N]]*  defun      [[elisp:(outline-show-subtree+toggle)][||]]  <<org-dblock-write:b:elisp:defs/dblockDefun>> ~advice=(bx:dblock:control|wrapper)~  [[elisp:(org-cycle)][| ]]
" orgCmntEnd)
(advice-add 'org-dblock-write:b:elisp:defs/dblockDefun :around #'bx:dblock:control|wrapper)
(defun org-dblock-write:b:elisp:defs/dblockDefun (
;;;#+END:
                                                   <params)
   " #+begin_org
...
;;;#+BEGIN:  b:elisp:defs/dblockDefun :defName "org-dblock-write:b:elisp:file/workbench" :advice ("bx:dblock:control|wrapper")
(orgCmntBegin "
*  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_ _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_ [[elisp:(outline-show-branches+toggle)][|=]] [[elisp:(bx:orgm:indirectBufOther)][|>]] *[[elisp:(blee:ppmm:org-mode-toggle)][|N]]*  dblockDfn  [[elisp:(outline-show-subtree+toggle)][||]]  <<org-dblock-write:b:elisp:file/workbench>> ~advice=(bx:dblock:control|wrapper)~  [[elisp:(org-cycle)][| ]]
" orgCmntEnd)
(advice-add 'org-dblock-write:b:elisp:file/workbench :around #'bx:dblock:control|wrapper)
(defun org-dblock-write:b:elisp:file/workbench (<params)
;;;#+END:
   " #+begin_org
** [[elisp:(org-cycle)][| DocStr |]] Process dblock args
Based on outCommentPreContent, bodyContent and outCommentPostContent.
#+end_org "
 ...
 [[elisp:(setq debug t)][debug-on-err]] \
 [[elisp:(setq  debug nil)][dont debug-on-err]] [[elisp:(org-cycle)][| ]]")
      (insert "\n")
