;;; newFile.el --- FILE DESCRIPTION COMES HERE  -*- lexical-binding: t; -*-
...
(defvar b:someVar "Some Value"
   " #+begin_org
** =b:someVar= Is used for this and that.
#+end_org "
  )
...
;;;#+BEGIN:  b:elisp:defs/cl-defun :defName "b:newF3"
(orgCmntBegin "
* [[elisp:(show-all)][(>]]  =cl-defun= <<b:newF3>> [[elisp:(org-shifttab)][<)]] E|
" orgCmntEnd)
(cl-defun b:newF3 (
;;;#+END:
                   )
