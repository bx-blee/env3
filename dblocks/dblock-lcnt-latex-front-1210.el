...
")
    ...
    (when (equal bx:class "art+pres")
      (insert "\\usepackage{beamerarticle}\n\n"))
...
\\RCSdef $Revision: 1.1 $
\\RCSdef $Date: 2014-02-27 02:45:42 $
\\RCSdef $Source: /cvsd/rep1/profile/intra/employee/lisp/dblock/dblock-lcnt-latex-front-1210.el,v $
\\RCSdef $Name:  $
...
{\\bf Copyright} \\copyright \\space  {\\bf  2012 %s}
" lcnt-authorName1))
