...
;;;#+BEGIN: b:elisp:pkg/fullUpdate :outLevel 1 :pkgsStage "ready" :pkgAdoptionType "bnpa" :pkgName "comeega"
(orgCmntBegin "
...
;;;#+BEGIN: b:elisp:pkg:install/update :outLevel 1 :pkgsStage "ready" :pkgAdoptionType "bnpa" :pkgName "comeega"
(orgCmntBegin "
* [[elisp:(show-all)][(>]]  =defun= <<bnpa:comeega:install|update>> [[elisp:(org-shifttab)][<)]] E|
" orgCmntEnd)
(defun bnpa:comeega:install|update ()
 "comeega package adoption install or update template."
 (b:log|entry (b:func$entry))
 (if b:g:dev:mode?
...
;;;#+BEGIN: b:elisp:pkg:config/main :outLevel 1 :pkgsStage "ready" :pkgAdoptionType "bnpa" :pkgName "comeega"
(orgCmntBegin "
* [[elisp:(show-all)][(>]]  =defun= <<bnpa:comeega:install|update>> [[elisp:(org-shifttab)][<)]] E|
" orgCmntEnd)
